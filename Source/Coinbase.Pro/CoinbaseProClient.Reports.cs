...
namespace Coinbase.Pro
{
   public interface IReportsEndpoint
   {
      ...
      Task<Report> CreateReport(CreateReport createReport);
      ...
      Task<Report> GetReportStatusAsync(string reportId);
   }
   ...
   public partial class CoinbaseProClient : IReportsEndpoint
   {
      ...
      public Task<Report> CreateReport(CreateReport createReport)
      {
         return this.ReportsEndpoint
            .WithClient(this)
            .PostJsonAsync(createReport)
            .ReceiveJson<Report>();
      }

      Task<Report> IReportsEndpoint.GetReportStatusAsync(string reportId)
      {
         return this.ReportsEndpoint
            .WithClient(this)
